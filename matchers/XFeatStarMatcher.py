...
class XFeatStarMatcher(object):
    ...
    def __init__(self, config={}):
        ...
        logging.info("XFeat star matcher config: ")
        ...
        logging.info("creating XFeat star matcher...")
    ...
    def __call__(self, kptdescs):
        ...
        logging.debug("matching keypoints with XFeat match_xfeat_star...")
