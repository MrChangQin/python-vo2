...
class XFeatLightGlueMatcher(object):
    default_config = {
        "top_k": 4096,
        "min_conf": 0.1,
        "weights": "third_party/xfeat/weights/xfeat.pt",
    ...
    def __init__(self, config={}):
        ...
        logging.info("XFeat LightGlue matcher config: ")
        ...
        logging.info("creating XFeat LightGlue matcher...")
    ...
    def __call__(self, kptdescs):
        ...
        logging.debug("matching keypoints with XFeat + LightGlue...")
