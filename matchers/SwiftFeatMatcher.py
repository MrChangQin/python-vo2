...
class SwiftFeatMatcher(object):
    ...
    def __init__(self, config={}):
        ...
        logging.info("SwiftFeat matcher config: ")
        ...
        logging.info("creating SwiftFeat matcher...")
    ...
    def __call__(self, kptdescs):
        ...
        logging.debug("matching keypoints with SwiftFeat match_xfeat...")
